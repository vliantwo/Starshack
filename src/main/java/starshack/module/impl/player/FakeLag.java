...
public class FakeLag extends Module {
    ...
    private void rebindLagRequest() {
        ...
        Stars.lagHandler.requestLag(activeLagRequest);
    }
    ...
    public void onGameTick(GameTickEvent e) {
        ...
        if (directions.contains(EnumLagDirection.INBOUND)) {
            Stars.lagHandler.releaseExpiredPackets(EnumLagDirection.INBOUND, delayMs);
        }
        if (directions.contains(EnumLagDirection.OUTBOUND)) {
            Stars.lagHandler.releaseExpiredPackets(EnumLagDirection.OUTBOUND, delayMs);
        }
    }
