...
public class GhostHand extends Module {
    ...
    private boolean heldItemAllowed() {
        ...
        switch (classify(held)) {
            case SWORD:
                return useSword.isToggled();
            case TOOL:
                return useTool.isToggled();
            case FISTS:
                return useFists.isToggled();
            case BUCKET:
                return useBucket.isToggled();
            case FLINT_STEEL:
                return useFlintSteel.isToggled();
            case COBWEB:
                return useCobweb.isToggled();
            default:
                return useOther.isToggled();
        }
    }
