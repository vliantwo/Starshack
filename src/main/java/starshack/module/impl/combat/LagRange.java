...
public class LagRange extends Module {
    ...
    public void onPrePlayerInteract(PrePlayerInteractEvent e) {
        ...
        if (ModuleManager.killAura != null && ModuleManager.killAura.isAutoBlockActive()) {
            if (isLagging) flushLag();
            return;
        }
        ...
        if (currentTarget != null) {
            ...
            if (isLagging) {
                ...
                Stars.lagHandler.releaseExpiredPackets(EnumLagDirection.OUTBOUND, (long) maximumDelay.getInput());
    ...
    public void onRenderWorld(RenderWorldLastEvent e) {
        ...
        Vec3 delayedPos = Stars.lagHandler.getLastReleasedServerPosition();
        if (delayedPos == null) {
            clearIndicatorInterp();
            return;
        }
    ...
    private void startLag() {
        ...
        Stars.lagHandler.requestLag(outboundLag);
        isLagging = true;
    }
