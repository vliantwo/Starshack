...
public class SecureClassLoader extends URLClassLoader {
    private static final List<String> WHITELISTED_PACKAGES = Arrays.asList("sun.reflect", "starshack", "java.lang", "java.util", "java.awt");
    ...
    private boolean isClassSafe(String name) {
        ...
        boolean isAllowedImport = Stars.scriptManager.imports.stream().anyMatch(prefix -> name.toLowerCase().startsWith(prefix));
