package starshack.script.packet.clientbound;

import starshack.script.model.ItemStack;
...
public class S04 extends SPacket {
    ...
    public S04(int entityId, int slot, starshack.script.model.ItemStack item) {
