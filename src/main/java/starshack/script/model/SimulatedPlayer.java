package starshack.script.model;

import com.google.common.base.Predicate;
import com.google.common.collect.Lists;
import starshack.mixin.impl.accessor.IAccessorEntity;
import starshack.mixin.impl.accessor.IAccessorEntityLivingBase;
...
public class SimulatedPlayer {
    ...
    public void moveEntity(double xMotion, double yMotion, double zMotion) {
        ...
        if (noClip) {
            ...
            net.minecraft.block.Block block1 = worldObj.getBlockState(blockPos).getBlock();
            if (block1.getMaterial() == Material.air) {
                net.minecraft.block.Block block = worldObj.getBlockState(blockPos.down()).getBlock();
