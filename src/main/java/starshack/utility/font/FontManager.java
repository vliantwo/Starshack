package starshack.utility.font;
...
public final class FontManager {
    ...
    private static final String RESOURCE_ROOT = "/assets/starshack/fonts/";
    /**
    ...
    private static final BundledFont[] BUNDLED_FONTS = {
            ...
            new BundledFont("Eclipse SF", "Eclipse-SF.ttf"),
            new BundledFont("Eclipse SF Bold", "Eclipse-SFBold.ttf"),
            new BundledFont("Eclipse SF Thin", "Eclipse-SFThin.ttf"),
            new BundledFont("Eclipse Whitney", "Eclipse-Whitney.ttf")
    };
    ...
    public static int getDefaultEclipseFontOptionIndex() {
        for (int i = 0; i < HUD_FONT_OPTIONS.length; i++) {
            if ("Eclipse SF".equals(HUD_FONT_OPTIONS[i])) {
                return i;
            }
        }
        return 0;
    ...
    public static RavenFontRenderer getRendererForEclipseUi(float pixelHeight) {
