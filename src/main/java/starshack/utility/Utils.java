...
public class Utils implements IMinecraftInstance {
    ...
    public static boolean addEnemy(String name) {
        if (Stars.playerRelationsManager != null) {
            ...
            return Stars.playerRelationsManager.addEnemy(name);
        }
    ...
    public static boolean removeEnemy(String name) {
        if (Stars.playerRelationsManager != null) {
            return Stars.playerRelationsManager.removeEnemy(name);
        }
    ...
    public static boolean removeFriend(String name) {
        if (Stars.playerRelationsManager != null) {
            return Stars.playerRelationsManager.removeFriend(name);
        }
    ...
    public static boolean addFriend(String name) {
        if (Stars.playerRelationsManager != null) {
            return Stars.playerRelationsManager.addFriend(name);
        }
    ...
    public static boolean isEnemy(String name) {
        ...
        if (Stars.playerRelationsManager != null) {
            return Stars.playerRelationsManager.isEnemy(name);
        }
    ...
    public static boolean isFriended(String name) {
        ...
        if (Stars.playerRelationsManager != null) {
            return Stars.playerRelationsManager.isFriend(name);
        }
    ...
    public static ItemStack getSpoofedItem(ItemStack original) {
        if (ModuleManager.scaffold != null && ModuleManager.scaffold.isEnabled()
                && ModuleManager.scaffold.itemSpoof.isToggled() && mc.thePlayer != null) {
            int slot = ModuleManager.scaffold.getSlot();
            if (slot >= 0 && slot < 9) {
