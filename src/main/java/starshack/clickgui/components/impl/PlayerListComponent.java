...
import starshack.utility.PlayerSkinCache;
...
public class PlayerListComponent extends AbstractTextInputComponent {
    private static final String CLOSE_ICON_PATH = "/assets/starshack/textures/gui/close.png";
    ...
    public void onScroll(int scroll) {
        ...
        float scrollSpeed = (float) starshack.module.impl.client.Gui.scrollSpeed.getInput();
