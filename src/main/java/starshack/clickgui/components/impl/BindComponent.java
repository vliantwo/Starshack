...
public class BindComponent extends Component {
    private static final String EYE_ICON_PATH = "/assets/starshack/textures/gui/eye.png";
    private static final String EYE_OFF_ICON_PATH = "/assets/starshack/textures/gui/eye_off.png";
    ...
    public boolean isBaseVisible() {
        return keySetting == null || keySetting.visible;
    }
    ...
    public void render() {
        ...
        if (keySetting == null && !(moduleComponent.mod instanceof ProfileModule)) {
    ...
    public boolean onClick(int x, int y, int button) {
        ...
        if (button == 0 && !(moduleComponent.mod instanceof ProfileModule) && overEyeIcon(x, y)) {
            moduleComponent.mod.setHidden(!moduleComponent.mod.isHidden());
            if (Stars.currentProfile != null) Stars.currentProfile.getModule().saved = false;
            return true;
        }
        if ((keySetting != null || moduleComponent.mod.canBeEnabled()) && button == 0 && overBindText(x, y)) {
            isBinding = !isBinding;
            return true;
        }
        if ((keySetting != null || moduleComponent.mod.canBeEnabled()) && button > 1 && isBinding) {
